...
\tolerance=400			%
\clubpenalty=10000		% Alterao Vincius
\widowpenalty=10000		%
...
%ambiente para definies, teoremas etc...
...
\usepackage{capaUEMquali}      % Para formatao de capa e folhas de rosto
%%
%% ---------------------------------------------------------------
\usepackage[
    sort&compress,
    %numbers,
    authoryear,
    ]{natbib} % Para usar estilo novo de referncias
\usepackage{verbatim}
\usepackage{titlesec}
...
\let\cite=\citep    % O natbib requer \citep para referncias. Ento, se vc j escreveu muita coisa usando \cite, este comando substitui na hora de compilar
...
%% Limpa os cabealhos, deixando s o nmero da pgina
\renewcommand{\headrulewidth}{0pt}
\pagestyle{fancyplain}
\fancyhf{}
\rhead{\fancyplain{}{\thepage}}

%% Muda a formataao dos ttulos das listas de figuras, tabelas e sumrio
\makeatletter
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estilos diferentes para cabealho de captulo - by Adenilso
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\makeatletter  %usado para que o @ seja considerado
 \newcounter{capkind}
 \setcounter{capkind}{1}   % define qual tipo de cabealho usar
 ...
 \begingroup
   \vspace*{50\p@}%
      ...
      {\begin{tabular}{|c|}
          ...
          %\hline
          \vspace{-2ex}\\ %coloquei para aumentar o espao entre o ttulo e o nmero
 ...
 \def\@makeschapterhead#1{%       Essa parte configura o cabealho do captulo referncias
...
\include{texto/_fundamentacao_teorica}
\include{texto/_ontologia}
\include{texto/_avalicao_da_ontologia}
\include{texto/_melhorias}
...
\include{texto/apendice_a}
\include{texto/apendice_b}
\include{texto/apendice_c}
\include{texto/apendice_d}
