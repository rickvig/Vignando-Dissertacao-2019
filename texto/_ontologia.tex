\chapter{Uma Ontologia para Experimentos em LPS - OntoExper-SPL}
\pagestyle{plain}
\label{sec:ontologia}
...
Com base nas tipologias proposta por \citet{almeida2003visao} definimos o tipo da ontologia proposta neste trabalho, descrito na Tabela \ref{tab:tipo-modelo-ontologia}.
...
\begin{figure}[htb]
	...
	\caption{Grafo inicial da proposta de ontologia. Fonte o Autor}
...
\begin{landscape}
	...
	\begin{figure}[htb]
		\centering 
		\caption{Modelo Conceitual Clusterizado. Fonte o Autor}
...
\begin{landscape}
	...
	\begin{figure}[htb]
		\centering
		\caption{Diagrama de classes para a modelagem da ontologia. Fonte o Autor}
...
\begin{table*}[!htb]
	\centering
	\caption{Resumo dos resultado da avaliação executada por OOPS!. Traduzido e adaptado.}
