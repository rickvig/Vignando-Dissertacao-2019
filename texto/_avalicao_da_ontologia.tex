...
A tese de /cite{Denny Vrandecic} não expoem uma forma clara para mensurar os oito critérios definidos por ele. Neste ponto foi definido que uma escala Likert poderia auxiliar nesse sentido. Segundo /cite{Likert} uma escala Likert para gerar bons resultados deve possuir três elementos fundamentais, (i) um negativo, (ii) um neutro e (iii) um positivo.
...
\section{Propostas de Melhoria para SMartOntology}
\label{sec:propostas_de_melhoria_para_smartontology}
