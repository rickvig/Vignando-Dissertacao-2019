\chapter{Protótipo de um Sistema de Recomendação para OntoExper-SPL}
\pagestyle{plain}
\label{sec:recsys}
...
\begin{figure}[htb]
	\centering					
	\caption{Passos de Construção para um RSSE}
...
\begin{table}[]
	\centering
	\small
	\caption{Sumário de técnicas de recomendação em cada domínio}
