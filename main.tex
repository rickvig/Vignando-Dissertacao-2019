...
\newcommand{\source}[1]{ {\\Fonte: {#1}} } % Henrique Vignando
...
\Jtitulo{OntoExper-SPL: uma ontologia de apoio a experimentos de linha de produto de software}
%\Jsubtitulo{: uma nova soluo ...} %% descomente essa linha caso haja um subttulo
\Jtituloabs{OntoExper-SPL: an ontology for supporting software product line experiments}
...
\JbancaA{Aline Maria Malachini Miotto Amaral}
...
\JbancaB{Katia Romero Felizardo Scannavino}
\JinstituicaoB{Universidade Tecnológica Federal do Paraná --- UTFPR}

% Dados da defesa
% \Jdatadefesa{21 de Fevereiro de 2019.}
% \Jlocaldefesa{Sala 120, Bloco C56, \textit{campus} da Universidade Estadual de Maringá.}
